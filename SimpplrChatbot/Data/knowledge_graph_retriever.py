...
class KnowledgeGraph:
    ...
    def _extract_concepts(self, splits, llm):
        ...
        with ThreadPoolExecutor() as executor:
            future_to_node = {
                executor.submit(
                    self._extract_concepts_and_entities, split.page_content, llm
                ): i
                for i, split in enumerate(splits)
            }
    ...
    def _expand_context(
        ...
        for doc in relevant_docs:
            ...
            closest_node = next(
                ...
                if self.knowledge_graph.graph.nodes[n]["content"]
        ...
        while priority_queue:
            ...
            if current_node not in traversal_path:
                ...
                node_concepts = self.knowledge_graph.graph.nodes[current_node][
                    "concepts"
                ]
                    ...
                    for neighbor in self.knowledge_graph.graph.neighbors(current_node):
                        ...
                        if distance < distances.get(neighbor, float("inf")):
                            ...
                            if neighbor not in traversal_path:
                                ...
                                neighbor_content = self.knowledge_graph.graph.nodes[
                                    neighbor
                                ]["content"]
                                neighbor_concepts = self.knowledge_graph.graph.nodes[
                                    neighbor
                                ]["concepts"]
